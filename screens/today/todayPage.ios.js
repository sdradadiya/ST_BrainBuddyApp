...
import {
    ...
    StatusBar,
    Alert,
    AppState, PushNotificationIOS, Animated, NativeModules, NetInfo, Linking,
} from 'react-native';
...
import {
    ...
    manageTodayInstances, removeSafeArea, manageRewiringPopup,
...
import {resetAllAsyncStorageData, showThemeAlert, getCurrentMonth, isReligious} from "../../helper/appHelper";
...
const iconImage = {
    ...
    notificationIcon:require('../../assets/images/card-icon-notifications.png'),
    ...
    setOptionalActivities = () => {
        ...
        PushNotificationIOS.checkPermissions(res=>{
            if(res.alert == 1) {
                ...
                if(_.find(this.props.todayScreenExercise,{pageName: "notificationsReminder"}) === undefined
                    || _.find(this.props.todayScreenExercise,{pageName: "notificationsReminder", isSelected: true}) !== undefined){

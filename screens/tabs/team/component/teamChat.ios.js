...
import {
    ...
    Text,
    FlatList,
    PushNotificationIOS, Alert, AsyncStorage, NativeModules,
} from 'react-native';
...
class TeamChat extends React.PureComponent {
    ...
    setReadBadgeValue = () => {
        PushNotificationIOS.getApplicationIconBadgeNumber((n)=>{
            // setBadgeValue.setBadgeCountInAppGroup((error, events) => {
            //     console.log("call");
            // });
                ...
                AsyncStorage.getItem('isShownNotificationAlert')
                    .then(isAsk => {
                        if(isAsk){
                            ...
                            Alert.alert("Chat notifications enabled",
                                "You will be notified when team members post in your team chat. Visit " +

...
export default  class WhenStress extends React.PureComponent {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TitleComponent title="When I'm Stressed" color={appColor.defaultFont}/>
                <View style={ styles.outerView }>
                    {
                        Object.keys(this.props.whenStressed).map((obj,index) => {
                            return <SubCellComponent title={obj}
                                                     progressVal = {this.props.whenStressed[obj]}
